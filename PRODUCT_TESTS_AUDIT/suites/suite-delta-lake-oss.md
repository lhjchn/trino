...
- Expected mapped classes covered: `TestDeltaLakeActiveFilesCache`, `TestDeltaLakeAlterTableCompatibility`,
  ...
  `TestDeltaLakeTransactionLogCache`, `TestDeltaLakeWriteDatabricksCompatibility`, `BaseTestDeltaLakeMinioReadsJunit`.
- Expected mapped methods covered: `146` method(s).
...
- Exclude tags: none.
- Expected mapped classes covered: `BaseTestDeltaLakeHdfsReadsJunit`.
...
- Expected migrated class count: `25`
- Expected migrated method count: `178`
- Expected migrated classes covered: `BaseTestDeltaLakeHdfsReadsJunit`, `BaseTestDeltaLakeMinioReadsJunit`,
...
- Expected migrated methods covered: `BaseTestDeltaLakeHdfsReadsJunit.testReads`,
