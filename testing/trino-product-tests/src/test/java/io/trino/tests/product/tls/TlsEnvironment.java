        ...
        extends ProductTestEnvironment
{
    ...
    public Connection createTrinoConnection()
            throws SQLException
    {
        return DriverManager.getConnection(jdbcUrl(), "hive", null);
    }
    ...
    {
        return "jdbc:trino://%s:%d?SSL=true&SSLVerification=NONE".formatted(trino.getHost(), trino.getMappedPort(HTTPS_PORT));
    }
    ...
    private static String tlsConfigProperties()
    {
        return """
                ...
                discovery.uri=https://localhost:7778
