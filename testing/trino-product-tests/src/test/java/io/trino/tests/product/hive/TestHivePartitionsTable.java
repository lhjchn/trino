...
class TestHivePartitionsTable
{
    ...
    @Test
    @Disabled("Requires hive.max-partitions-per-scan=100 configuration - cannot be enabled without environment-level config changes that would affect other tests")
    @Flaky(issue = RETRYABLE_FAILURES_ISSUES, match = RETRYABLE_FAILURES_MATCH)
