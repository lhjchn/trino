        ...
        extends ProductTestEnvironment
{
    ...
    private void configureHadoop(HadoopContainer container, String gcpCredentialsJson, String gcpStorageBucket, String gcsTestDirectory)
    {
        ...
        String applyScript = """
                ...
                apply-site-xml-override /opt/hadoop/etc/hadoop/core-site.xml "/docker/trino-product-tests/conf/environment/multinode-gcs/core-site-overrides.xml"
                apply-site-xml-override /opt/hive/conf/hive-site.xml "/docker/trino-product-tests/conf/environment/multinode-gcs/hive-site-overrides.xml"
                """;
