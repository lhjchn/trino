...
class TestHiveViewCompatibility
{
    ...
    void testSelectOnView(HiveSparkEnvironment env)
    {
        ...
        try {
            ...
            env.executeTrinoUpdate("CREATE VIEW hive.default.hive_test_view AS SELECT * FROM hive.default." + SOURCE_TABLE);
    ...
    void testExistingView(HiveSparkEnvironment env)
    {
        prepareSourceTable(env);
        try {
            env.executeTrinoUpdate("DROP VIEW IF EXISTS hive.default.hive_duplicate_view");
            env.executeTrinoUpdate("CREATE VIEW hive.default.hive_duplicate_view AS SELECT * FROM hive.default." + SOURCE_TABLE);
    ...
    void testCommentOnViewColumn(HiveSparkEnvironment env)
    {
        ...
        try {
            ...
            env.executeTrinoUpdate("DROP VIEW IF EXISTS hive.default.hive_test_view_comment_column_compatibility");
            env.executeTrinoUpdate("CREATE VIEW hive.default.hive_test_view_comment_column_compatibility AS SELECT * FROM hive.default." + SOURCE_TABLE);
    ...
    /**
     * Assert that a query on a view executes successfully through Trino.
     */
