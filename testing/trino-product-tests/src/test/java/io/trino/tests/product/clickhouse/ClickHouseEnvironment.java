...
/**
 * ClickHouse product test environment.
 */
public class ClickHouseEnvironment
        extends ProductTestEnvironment
{
    ...
    public void start()
    {
        ...
        trino = TrinoProductTestContainer.builder()
                .withNetwork(network)
                .withCatalog("clickhouse", Map.of(
                        "connector.name", "clickhouse",
                        "connection-url", "jdbc:clickhouse://clickhouse:8123/default",
                        "connection-user", clickhouse.getUsername(),
                        "connection-password", clickhouse.getPassword()))
                .build();
        trino.start();
